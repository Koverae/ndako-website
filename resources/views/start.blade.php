...
@section('title', 'Get Early Access')

@section('open-graph')
<meta name="theme-color" content="#026469">
<meta property="og:title" content="Ndako - Get Early Access">
...
<section class="py-[200px] max-md:pt-150 relative overflow-hidden">
  ...
  >
    <div class="mb-12 text-center max-w-[475px] mx-auto">
      <p class="section-tagline">Join now and be among the first to experience seamless hotel management</p>
          ...
          <form method="POST" action="{{ route('demo.store') }}">
            ...
            <div class="grid grid-cols-12 max-md:gap-y-10 md:gap-x-12 md:gap-8">
              ...
              <div id="otp-section" class="hidden">
                  ...
                  <button type="button" onclick="verifyOTP()" class="w-full p-2 text-white bg-green-500 rounded">Verify</button>
              </div>
