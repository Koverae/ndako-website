...
@section('content')
<section id="hero" class="justify-content-center d-flex">
    <div class="shadow-lg k_website_register card">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('register') }}" class="k_register_form">
                @csrf
                ...
                <div class="mt-2 mb-3 row">
                    <div class="mb-2 col-12">
                        <h6 class="m-0 font-weight-bold">{{ __('General Informations') }}</h6>
                ...
                <div class="mt-2 mb-3 row">
                    <div class="mb-2 col-12">
                        <h6 class="m-0 font-weight-bold">{{ __('Contact Informations') }}</h6>
                ...
                <div class="mt-2 mb-3 row">
                    <div class="mb-2 col-12">
                        <h6 class="m-0 font-weight-bold">{{ __('Security Informations') }}</h6>
                ...
                <button class="btn b-primary w-100 float-start text-uppercase font-weight-bold" type="submit">
                    {{ __('Create my Account') }}
                </button>
                <div class="pt-1 mb-1 text-center k_login_buttons">

                    <div class="links-container">
                        @if(Route::has('login'))
                            <a href="{{ route('login')}}" class="login-link text-primary">{{ __("Already have an account?") }}</a>
                        @endif
                    </div>
                </div>
                <small style="font-size: 14px;"><i class="bi bi-info-circle-fill"></i> {{ new Illuminate\Support\HtmlString(__("We will handle your personal data as described in our <a class=\"hover:underline\" href=\":url\">Privacy Policy</a>.", ['url' => route('verify.resend')])) }}</small>
            </form>
        </div>
    </div>
</section>
