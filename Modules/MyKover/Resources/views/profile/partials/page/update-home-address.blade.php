...
@section('page_title', "Home Address")
...
<div class="text-black container-md w-100">
    <header class="mb-2 text-left border-bottom">
        <h3><a href="{{ route('profile.edit') }}"><i class="bi bi-arrow-left-circle"></i></a> {{ __('Home Address') }}</h3>
    </header>
    <section class="p-lg-3">
        <form class="container p-3 rounded k-form" method="post" action="{{ route('profile.update.home-address') }}">
            @csrf
            @method('patch')
            ...
            <h6 class="mt-3">{{ __('Your home Address') }}</h6>
            <div class="mb-3 row">
